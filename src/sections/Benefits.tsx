...
const benefits: Benefit[] = [
  {
    ...
    description: 'Zamonaviy pechlar yordamida maksimal mustahkamlik va sifat kafolati',
  ...
  },
  {
    id: 3,
    title: 'Ko\'chma model',
    description: 'Oson ko\'chirish va o\'rnatish imkoniyati - xoh uyingizda, xoh bog\'ingizda',
      ...
      <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-tandir-gold/20 rounded-full mb-6">
            ...
            <span className="text-tandir-text-secondary text-sm">Bizning afzalliklarimiz</span>
          </div>
          <h2 className="font-display text-4xl sm:text-5xl md:text-6xl text-tandir-text mb-4">
            Nima uchun <span className="text-tandir-gold">bizni tanlashadi?</span>
          </h2>
